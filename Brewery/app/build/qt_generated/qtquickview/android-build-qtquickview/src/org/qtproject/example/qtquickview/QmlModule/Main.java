...
package org.qtproject.example.qtquickview.QmlModule;
...
public final class Main extends QtQuickViewContent {
    ...
    public void setColorStringFormat(String colorStringFormat) { setProperty("colorStringFormat", colorStringFormat); }
    public String getColorStringFormat() { return this.<String>getProperty("colorStringFormat"); }
    public int connectColorStringFormatChangeListener(QtSignalListener<String> signalListener) {
        return connectSignalListener("colorStringFormat", String.class, signalListener);
    }
    ...
    public int connectOnClickedListener(QtSignalListener<Void> signalListener) {
        return connectSignalListener("onClicked", Void.class, signalListener);
    }
}
