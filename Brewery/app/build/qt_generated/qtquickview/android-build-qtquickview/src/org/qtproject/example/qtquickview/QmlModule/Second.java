...
public final class Second extends QtQuickViewContent {
    ...
    @Override public String getFilePath() {
        return "qrc:/qt/qml/qmlModule/Second.qml";
    }
    ...
    public void setGridRotation(Integer gridRotation) { setProperty("gridRotation", gridRotation); }
    public Integer getGridRotation() { return this.<Integer>getProperty("gridRotation"); }
    public int connectGridRotationChangeListener(QtSignalListener<Integer> signalListener) {
        return connectSignalListener("gridRotation", Integer.class, signalListener);
    }
